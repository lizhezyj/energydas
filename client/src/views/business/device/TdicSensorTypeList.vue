        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="参数类型">
              <j-dict-select-tag placeholder="请选择参数编号" v-model="queryParam.tfDataTypeCode" dictCode="st_all_sensor_data_type,tf_data_type_name,tf_data_type_code"/>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8" >
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/sensor_type_manager/tdicSensorType/list",
          delete: "/sensor_type_manager/tdicSensorType/delete",
          deleteBatch: "/sensor_type_manager/tdicSensorType/deleteBatch",
          exportXlsUrl: "/sensor_type_manager/tdicSensorType/exportXls",
          importExcelUrl: "sensor_type_manager/tdicSensorType/importExcel",
        },
        dictOptions:{
         tfDataTypeCode:[],
         tfDataTypeName:[],
    ...
    mounted() {
      if (this.$route.query.tfSensorDataTypeCode) { //传感器安装页面跳转
        this.handleAdd()
      }
    },
    methods: {
