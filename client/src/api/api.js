...
////根路径
// const doMian = "/mess-boot/";
////图片预览请求地址
// const imgView = "http://localhost:8080/mess-boot/sys/common/view/";
...
//  project tree
const queryTbProjectItemList = (params)=>getAction("/pProjectItemTree/tbProjectItemTree/queryTreeList",params);
const searcTbProjectItemhByKeywords   = (params)=>getAction("/pProjectItemTree/tbProjectItemTree/searchBy",params);
...
export const ajaxGetDictItemsWhere = (code, params)=>getAction(`/sys/dict/getDictItems/${code}`,params);
//系统通告
...
// 添加传感器设备，触发生成配置文件接口
const getSensorPointerProfile = (params)=>getAction("/collecterProductCode/getPolicy",params);
...
export {
  ...
  addPermission,
  editPermission,
  queryTbProjectItemList,
  searcTbProjectItemhByKeywords,
  queryTreeList,
  queryListAsync,
  queryRolePermission,
  saveRolePermission,
